...
public class SublistaAView extends ViewPart{
	public static final String ID = "com.medweb.ui.medicamente.sublistaAView";
	...
	private void createHeadComposite(Group composite){
		...
		Label info1=WidgetFactory.createLabel(composite, "info1",MedicamenteMessages.EDIT_SUBLISTA_INFO_A1.getMessage());
		info1.setLayoutData(new GridData(SWT.FILL,SWT.FILL,true,false,6,1));
		addBlankLabels(composite, 1);
		
		Label info2=WidgetFactory.createLabel(composite, "info2",MedicamenteMessages.EDIT_SUBLISTA_INFO_A2.getMessage());
		info2.setLayoutData(new GridData(SWT.FILL,SWT.FILL,true,false,8,1));
		
		Label info3=WidgetFactory.createLabel(composite, "info3",MedicamenteMessages.EDIT_SUBLISTA_INFO_A3.getMessage());
	 ...
	 private List<Object> tableInputObject(){
			...
			try {
				listMedicament = this.medicamentModel.getBusinessService()
						.getSublistaMedicamente(SublistaEnum.SUBLISTA_A.getOrdinalValue());
