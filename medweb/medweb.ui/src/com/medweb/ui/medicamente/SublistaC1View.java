...
public class SublistaC1View extends ViewPart{
	public static final String ID = "com.medweb.ui.medicamente.sublistaC1View";
	...
	private void createHeadComposite(Group composite){
		...
		Label info1=WidgetFactory.createLabel(composite, "info1",MedicamenteMessages.EDIT_SUBLISTA_INFO1_C1.getMessage());
		info1.setLayoutData(new GridData(SWT.FILL,SWT.FILL,true,false,6,1));
		addBlankLabels(composite, 1);
		
		Label info2=WidgetFactory.createLabel(composite, "info2",MedicamenteMessages.EDIT_SUBLISTA_INFO2_C1.getMessage());
		info2.setLayoutData(new GridData(SWT.FILL,SWT.FILL,true,false,8,1));
		
		Label info3=WidgetFactory.createLabel(composite, "info3",MedicamenteMessages.EDIT_SUBLISTA_INFO3_C1.getMessage());
		info3.setLayoutData(new GridData(SWT.FILL,SWT.FILL,true,false,8,1));
	
		Label info4=WidgetFactory.createLabel(composite, "info4",MedicamenteMessages.EDIT_SUBLISTA_INFO4_C1.getMessage());
		info4.setLayoutData(new GridData(SWT.FILL,SWT.FILL,true,false,8,1));
		
		Label info5=WidgetFactory.createLabel(composite, "info5",MedicamenteMessages.EDIT_SUBLISTA_INFO5_C1.getMessage());
		info5.setLayoutData(new GridData(SWT.FILL,SWT.FILL,true,false,8,1));
	}
		 ...
		 List<Object> list=new ArrayList<Object>();
			...
			try {
				listMedicament = this.medicamentModel.getBusinessService()
						.getSublistaMedicamente(SublistaEnum.SUBLISTA_C1.getOrdinalValue());
