...
public class SublistaC2View extends ViewPart{
	public static final String ID = "com.medweb.ui.medicamente.sublistaC2View";
	...
	private void createHeadComposite(Group composite){
		...
		Label info1=WidgetFactory.createLabel(composite, "info1",MedicamenteMessages.EDIT_SUBLISTA_INFO1_C2.getMessage());
		info1.setLayoutData(new GridData(SWT.FILL,SWT.FILL,true,false,6,1));
		addBlankLabels(composite, 1);
		
		Label info2=WidgetFactory.createLabel(composite, "info2",MedicamenteMessages.EDIT_SUBLISTA_INFO2_C2.getMessage());
		info2.setLayoutData(new GridData(SWT.FILL,SWT.FILL,true,false,8,1));
		
		Label info3=WidgetFactory.createLabel(composite, "info3",MedicamenteMessages.EDIT_SUBLISTA_INFO3_C2.getMessage());
		info3.setLayoutData(new GridData(SWT.FILL,SWT.FILL,true,false,8,1));
		
		addBlankLabels(composite, 1);
		Label info4=WidgetFactory.createLabel(composite, "info4",MedicamenteMessages.EDIT_SUBLISTA_INFO4_C2.getMessage());
		info4.setLayoutData(new GridData(SWT.FILL,SWT.FILL,true,false,6,1));
		addBlankLabels(composite, 1);
	}
		 ...
		 List<Object> list=new ArrayList<Object>();
			...
			try {
				listMedicament = this.medicamentModel.getBusinessService()
						.getSublistaMedicamente(SublistaEnum.SUBLISTA_C2.getOrdinalValue());
