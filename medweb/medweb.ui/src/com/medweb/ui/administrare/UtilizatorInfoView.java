...
public class UtilizatorInfoView extends ViewPart{
	
		
		public static final String ID = "com.medweb.ui.administrare.utilizatorInfoView";
		...
		private void createHeadComposite(Group composite){
		 ...
		 private List<Object> tableInputObject(){
				...
				this.utilizatorModel.getMedicPrimarInfo();
				MedicPrimarInfo info = this.utilizatorModel.getMedicInfo();
		 ...
		 private void createBindings(){
			 ...
			 MedicPrimar medic=utilizatorModel.getMedicPrimar();
			 
			 numeMedicText.setText(medic.getNume());
			 prenumeMedicText.setText(medic.getPrenume());
			 
			 int index=0;
		     Iterator<CasaAsigurari> itCasa= this.utilizatorModel.getAllCasaAsigurari().iterator();
		 ...
		 private void createListeners(){
			 ...
			 saveAction.setModel(utilizatorModel);
